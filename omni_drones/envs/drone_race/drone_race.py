...
class DroneRaceEnv(IsaacEnv):
    ...
    def _design_scene(self):
        ...
        offset_world   = quat_rotate(
            first_gate_rot.unsqueeze(0), self.offset_local.unsqueeze(0)
        ).squeeze(0)
    ...
    def _compute_reward_and_done(self):
        ...
        collision_forces = self.drone.base_link.get_net_contact_forces()
        contact_crash  = collision_forces.squeeze(1).norm(dim=-1) > 1.0
